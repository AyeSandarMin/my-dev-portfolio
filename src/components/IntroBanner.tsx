...
const IntroBanner = ({ onEnterClick }: IntroBannerProps) => {
  ...
  const [isWelcomeAnimationActive, setIsWelcomeAnimationActive] = useState(true);
  ...
  useGSAP(() => {
    ...
    // Set initial position for main characters (below viewport)
    gsap.set(heroSplit.chars, { 
      yPercent: 100,
      opacity: 0
    });

    // Function to animate text with SplitText
    const animateText = (text: string, duration = 0.4) => {
      return new Promise<void>((resolve) => {
        ...
        setTimeout(() => {
          ...
          const split = new SplitText("#welcome-text", { type: "chars, words" });
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              gsap.to(heroSplit.chars, {
                ...
                stagger: 0.05,
                onComplete: () => {
                  // Show header and footer after h1 animation completes
                  gsap.to("#header-asdm", {
                    duration: 0.6,
                    opacity: 1,
                    y: 0,
                  ...
                  // Enable h1 scramble after all animations complete
  ...
  const handleMouseEnter = () => {
    // Only allow scramble if welcome animation is complete
    ...
    <div className="h-screen flex flex-col overflow-hidden bg-white">
      ...
      <div className="flex-1 flex justify-center items-center">
        <div className="relative text-center">
          {/* Welcome text - positioned absolutely to occupy same space */}
          <h2 id="welcome-text" className="font-bold text-8xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 whitespace-nowrap"></h2>
          
          {/* Main content - normal flow */}
          <div className="flex justify-center items-center">
            <h6 id="im-text" className="mr-4 text-2xl cursor-pointer">I'm</h6>
            <h1
